(() => {
  ...
  if (isSubpage) {
    ...
    if (nav) {
      const items = [
        ['home','../','Home'],['cases','../cases/','Cases'],['bibliography','../bibliography/','Bibliography'],
        ['sources','../sources/','Sources'],['auctions','../auctions/','Auctions'],['contact','../#contact','Contact']
      ];
    ...
    if (footer) {
      footer.innerHTML = `
        <span class="footer-identity"><a class="footer-title" href="../">The Blaschka Object Network</a><span class="footer-copyright">© 2026 Haohao Zhang. Site text and design unless otherwise credited. Source images and third-party materials retain their stated licences.</span></span>
        <span class="footer-links"><a href="../cases/">Cases</a><a href="../bibliography/">Bibliography</a><a href="../sources/">Sources</a><a href="../auctions/">Auctions</a><a href="../privacy/">Privacy</a><a class="footer-rss" href="../feed.xml" type="application/rss+xml" aria-label="RSS feed"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="5" cy="19" r="2.2"/><path d="M3 10.5v3a7.5 7.5 0 0 1 7.5 7.5h3A10.5 10.5 0 0 0 3 10.5Zm0-6v3A13.5 13.5 0 0 1 16.5 21h3C19.5 11.9 12.1 4.5 3 4.5Z"/></svg><span>RSS</span></a></span>`;
    }
  }
})();