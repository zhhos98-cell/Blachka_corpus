(() => {
  ...
  if (css) css.href = 'bibliography.css?v=20260810-4';

  /* Bibliography v1 is already flattened into index.html. Keep this file as a small
     compatibility/cleanup pass; never replay historical pass records at runtime. */
