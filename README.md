...
- Discovery layer: **287 collection/subcollection/batch/database entries**.
- Strict post-lock batches `07K`-`07AI`: **136 entries with explicit nineteenth-century object, maker, set, use, trade, collection, or provenance evidence**.
