...
- Discovery layer: **295 collection/subcollection/batch/database entries**.
- Strict post-lock batches `07K`-`07AJ`: **144 entries with explicit nineteenth-century object, maker, set, use, trade, collection, or provenance evidence**.
