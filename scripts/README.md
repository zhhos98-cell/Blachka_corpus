...
- `audit-json-schema-families.py` — profiles exact top-level key/type families and repeated list-item shapes into `schemas/schema-family-profile.json` plus a dated audit note.
